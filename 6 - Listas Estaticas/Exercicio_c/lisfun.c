...
Lista *Criar (int quant)
{
    Lista *l;
    l = (Lista *) malloc(sizeof(Lista));
    l->valores = (Aluno*) malloc((quant * sizeof(Aluno)));
    if(l != NULL)
    {
        l -> total = 0;
        l -> tam = quant;
...
int muda_tamanho(Lista *l, int t_novo)
{
    Aluno *aux;
    if(l == NULL) return 2;
    aux = (Aluno *) realloc(l ->valores, (t_novo * sizeof(Aluno)));
